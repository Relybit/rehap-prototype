...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('card-type'); ?>>
		<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'colorful' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark">
		...
		<div class="card-content">
			...
			<p class="card-text"><?php echo strip_tags(get_the_content()); ?><?php _e( '続きを読む', 'colorful' ); ?></p>
		</div>
		</a>
	</article><!-- #post -->
